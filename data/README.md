...
## Overview
This folder contains all datasets used for the Multi-Agent AI System 
for Academic Assistance project.

## Folder Structure
- raw/ — original downloaded datasets (unmodified)
- cleaned/ — cleaned and processed datasets ready for use
